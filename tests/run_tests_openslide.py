...
"""Main script to run all tests using openslide library.
...
dplabtools.config.slide_library = "openslide"
dplabtools.config.print_messages = make_log_path("openslide_screen_log.txt")
